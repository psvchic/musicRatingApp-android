...
public class ArtistProfileFragment extends Fragment {
    ...
    TextView textViewArtistName, textViewArtistDesc;
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);

        imageViewArtist = view.findViewById(R.id.artistImage);
        textViewArtistName = view.findViewById(R.id.artistName);
        textViewArtistDesc = view.findViewById(R.id.artistDesc);
        ...
        if(getArguments() != null){
            ...
            textViewArtistName.setText(getArguments().getString("name"));
            textViewArtistDesc.setText(getArguments().getString("description"));
        }
